...
def get_argparser():
    ...
    parser.add_argument("--n_steps_pretrain_geometry", type=int, default=10_000, help="Number of pretraining steps for geometry discovery")
    parser.add_argument("--update_chart_every_n_steps", type=int, default=150, help="Update chart every n steps")
    parser.add_argument("--evaluate_span_how", type=str, choices=["learn_weights", "orthogonal_complement"], default="orthogonal_complement", help="How to evaluate span")
    ...
    parser.add_argument("--lr_left_actions", type=float, default=0.00035, help="Learning rate for the left actions")
    parser.add_argument("--lr_generator", type=float, default=0.00035, help="Learning rate for the generator")
    parser.add_argument("--lr_chart", type=float, default=0.00035, help="Learning rate for chart updates")
