...
def get_argparser():
    ...
    parser.add_argument("--n_steps_geo", type=int, default=10_000, help="Number of optimization steps for the hereditary geometry discovery.")
    parser.add_argument("--n_steps_sym", type=int, default=10_000, help="Number of optimization steps for the symmetry discovery.")
